...
linear_model.save('saved_models/TTT_linear_multivariable')
...
for variable_name in list(dnn_history):    
    ...
    df1.to_csv('saved_results/TTT_dnn_history'+str([variable_name]))
    df2.to_csv('saved_results/TTT_linear_history'+str([variable_name]))
